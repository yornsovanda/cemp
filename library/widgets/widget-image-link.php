    ...
    function form( $instance )
    {
       ...
       <p>
            <label><?php _e( 'Image', 'sptheme_widget' ) ?>:
                ...
                <!-- <a href="media-upload.php?type=image&TB_iframe=true" class="upload-image button-secondary" id="upload-image">Upload</a><br /> -->
                <input type="button" value="Upload" class="upload-image button-secondary"><br />
